...
class _TeamResultPageState extends State<TeamResultPage> {
  ...
  final Map<String, String> challengeRanges = {
    'Sumo Cup MS': 'SumoCup!A2:D21',
    'Sumo Cup HS': 'SumoCup!F2:I21',
    'Sumo Cup UP': 'SumoCup!K2:N21',
    'Maze Solver MS': 'MazeSolver!A2:D21',
    'Maze Solver ES': 'MazeSolver!F2:I21',
    'Fire Fighter MS': 'FireFighter!A2:D21',
    'Fire Fighter HS': 'FireFighter!F2:I21',
    'Fire Fighter UP': 'FireFighter!K2:N21',
    'Line Follower MS': 'LineFollower!A2:D21',
    'Line Follower HS': 'LineFollower!F2:I21',
    'Line Follower ES': 'LineFollower!K2:N21',
    'Airpline MS': 'Airpline!A2:D21',
    'Airpline HS': 'Airpline!F2:I21',
    'Airpline UP': 'Airpline!K2:N21',
    'Fastbot MS': 'Fastbot!A2:D21',
    'Fastbot HS': 'Fastbot!F2:I21',
    'Fastbot ES': 'Fastbot!K2:N21',
    'Preshcool': 'Preschool!A2:D21',
    'Enterpreneurs MS': 'Enterpreneurs!A2:D21',
    'Enterpreneurs HS': 'Enterpreneurs!F2:I21',
    'Enterpreneurs ES': 'Enterpreneurs!K2:N21',
    'Enterpreneurs UP': 'Enterpreneurs!P2:S21',
  };
